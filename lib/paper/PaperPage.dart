...
import 'package:zotero_app/author/AuthorsButton.dart';
import 'package:zotero_app/library/AuthorHelper.dart';
...
class PaperPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(
            children: [
              ...
              paper.creators != null
                  ...
                  : Text("..."),
              Text(((paper.date?.length ?? -1) > 0) ? "(${paper.date})" : "",
                          ...
                          child: Flex(direction: Axis.vertical, children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.nInfluentialCit(
                                  snapshot.data?.influentialCitationsCount ??
                                      0),
                              style: TextStyle(
                                  fontStyle: FontStyle.italic, fontSize: 20),
                            ),
      ...
      floatingActionButton: new SharePaperButton(
          paper: paper, label: AppLocalizations.of(context)!.share),
    );
  }
}
