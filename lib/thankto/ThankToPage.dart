...
class ThankToPage extends StatelessWidget {
  final List<Source> sources = [
    Source(
        name: "Zotero",
        url: Uri.parse("https://www.zotero.org/support/dev/web_api/v3/start")),
    FlutterSource(
        name: 'oauth1',
    ...
    FlutterSource(
        name: 'intl',
        GitHubUrl: Uri.parse("https://github.com/dart-lang/intl"),
        license: "BSD"),
    FlutterSource(
        name: 'share_plus',
        GitHubUrl: Uri.parse(
        ...
        license: "BSD"),
    FlutterSource(
        name: 'liquid_glass_ui_design',
        GitHubUrl: Uri.parse("https://github.com/santhosh-ceo/liquid_glass_ui"),
        license: "MIT")
  ];
